    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./openpbr.vertex-HCJAQ65R.js"), import("./openpbr.fragment-NMIBZUKX.js")]);
        } else {
          await Promise.all([import("./openpbr.vertex-FWARQVY5.js"), import("./openpbr.fragment-MMXGMWCC.js")]);
        }
...
//# sourceMappingURL=chunk-AV5ADZL4.js.map
