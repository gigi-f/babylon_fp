    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./openpbr.vertex-XNMUOH3N.js"), import("./openpbr.fragment-LW3DVC45.js")]);
        } else {
          await Promise.all([import("./openpbr.vertex-3ANVT77L.js"), import("./openpbr.fragment-OYJWGNPR.js")]);
        }
...
//# sourceMappingURL=chunk-NIKIY2OJ.js.map
