  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_ShadowGenerator.ForceGLSL) {
      ...
      await Promise.all([
        ...
        import("./shadowMap.vertex-MZ7VSOXZ.js"),
      ...
      await Promise.all([
        ...
        import("./shadowMap.vertex-I7ZTVDCU.js"),
...
var DepthRenderer = class _DepthRenderer {
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_DepthRenderer.ForceGLSL) {
      this._shaderLanguage = 1;
      await Promise.all([import("./depth.vertex-N63Q5MGV.js"), import("./depth.fragment-CCK5JDXU.js")]);
    } else {
...
//# sourceMappingURL=chunk-H43GNGNT.js.map
