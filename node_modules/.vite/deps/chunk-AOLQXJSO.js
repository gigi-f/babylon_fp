    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./openpbr.vertex-RMHEKDWU.js"), import("./openpbr.fragment-SVEZLTSZ.js")]);
        } else {
          await Promise.all([import("./openpbr.vertex-7SGPML3O.js"), import("./openpbr.fragment-2VIQOSOP.js")]);
        }
...
//# sourceMappingURL=chunk-AOLQXJSO.js.map
