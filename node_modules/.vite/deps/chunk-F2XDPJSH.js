    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./pbr.vertex-BBU3L77F.js"), import("./pbr.fragment-IU5GCQII.js")]);
        } else {
          await Promise.all([import("./pbr.vertex-DSU3DE4O.js"), import("./pbr.fragment-3K5YBAJY.js")]);
        }
...
//# sourceMappingURL=chunk-F2XDPJSH.js.map
