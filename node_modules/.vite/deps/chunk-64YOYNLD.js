    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./pbr.vertex-HMGWFYBA.js"), import("./pbr.fragment-P7QNEPQV.js")]);
        } else {
          await Promise.all([import("./pbr.vertex-JEL243XL.js"), import("./pbr.fragment-D3JC5QYX.js")]);
        }
...
//# sourceMappingURL=chunk-64YOYNLD.js.map
